...
const { POST_IMMEDIATELY, PENDING, APPROVED, COLLECTION_OPTION_ALL, POST_AS_OPTION_FB_LINK, POSTING_SORTORDER_RANDOM, QUEUE_OPTIONS_PAUSE, FACEBOOK_DEFAULT_TEXT } = require('shared/constants');
...
describe('Rule Model', () => {
  ...
  beforeAll(async (done) => {
    ...
    const ruleParams = {
      ...
      ,
      postAsOption: POST_AS_OPTION_FB_LINK,
