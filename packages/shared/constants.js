...
exports.FACEBOOK_GRAPH_API_URL = 'https://graph.facebook.com/v7.0/'
...
// POSTING_SORTORDER
const POSTING_SORT_ORDER_NEWEST = 'newest';
const POSTING_SORTORDER_RANDOM = 'random';
exports.POSTING_SORT_ORDER_NEWEST = POSTING_SORT_ORDER_NEWEST;
...
//LINK_SHORTENER_SERVICES
const LINK_SHORTENER_SERVICES_NONE = 'none'
const LINK_SHORTENER_SERVICES_POOOST = 'pooost'
const LINK_SHORTENER_SERVICES_BITLY = 'bit.ly'
exports.LINK_SHORTENER_SERVICES_NONE = LINK_SHORTENER_SERVICES_NONE;
exports.LINK_SHORTENER_SERVICES_POOOST = LINK_SHORTENER_SERVICES_POOOST;
exports.LINK_SHORTENER_SERVICES_BITLY = LINK_SHORTENER_SERVICES_BITLY;
...
exports.POSTING_SORTORDER = [POSTING_SORT_ORDER_NEWEST, POSTING_SORTORDER_RANDOM];
...
exports.LINK_SHORTENER_SERVICES = [LINK_SHORTENER_SERVICES_NONE, LINK_SHORTENER_SERVICES_POOOST, LINK_SHORTENER_SERVICES_BITLY];
...
exports.PAYMENT_PLANS = [FREE_PLAN, BASIC_PLAN, PRO_PLAN];
